...
5. Retry transient download failures with exponential backoff (`--retries`, default 3) instead of aborting on the first stalled connection. Permanent 4xx responses are not retried, and an exhausted retry reports an error instead of panicking.
